...
{
    // Use fast modular exponentiation instead of the O(e) loop
...
{
    // Use fast modular exponentiation instead of the O(d) loop
...
{
    // Optimised RSA encryption using fast modular exponentiation
    return modularExponentiation(message, e, n);
}
...
{
    // Optimised RSA decryption using fast modular exponentiation
